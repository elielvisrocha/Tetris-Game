    document.addEventListener('DOMContentLoaded', () => {
        ...
        /*
        startBtn.addEventListener("focusin", () => {
            startBtn.style.border = "2px solid red";
            startBtn.addEventListener("focusout", () => {
                startBtn.style.border = "2px solid blue";
            })
        })
        */
        ...
        const theTretominoes = [lTetromino, zTetromino, tTetromino, oTetromino, iTetromino];
        ...
        function displayShape() {
            //remmove any trace of a tetromino form the entire grid
        ...
        //add functionality play/button to the button
